...
The sd is Na for one carrier OO \<- there is only one flight of that carrier therefore n= 1 and for sd the denominator is n-1 =0 therefore undefined. 0 for AS, F9 and HA because there's is no variation of the distance.
q3
```{r}
